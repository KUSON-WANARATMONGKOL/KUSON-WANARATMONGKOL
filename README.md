...
Three pillars run through everything I make:

| Pillar | Focus |
|---|---|
| **01 / Creativity — Design Logic** | Crafting immersive UI/UX with Figma and AI-driven image generation. |
| **02 / Engineering — Tech Solutions** | Exploring AR/NFC integrations and VR development with Unity and C#. |
| **03 / Strategy — Development** | Building scalable web applications with clean code and real performance in mind. |

I don't treat design, code, and strategy as separate disciplines — a product isn't finished until it looks right, runs right, *and* makes sense as something people would actually use.
...
- Iterating on **Gritt's** AI assistant so its scheduling advice gets sharper the more it learns about how a student actually works.
- Expanding **NewsFlow's** summarization coverage across more topics and sources.
- Keeping **Kuson Portfolio's** SEO, sitemap, and page speed sharp as new work gets added.
...
Not just a portfolio — a launchpad. I want to keep building products that solve a real, specific problem for a real, specific person, and get better at front-end engineering, product thinking, and UI/UX along the way. I'm working toward a career built on that same intersection: technology, art, and business, done with an entrepreneur's follow-through.

If you're building something, hiring, or just want to talk about an idea — I'm open to conversations, collaboration, and partnerships.
